...
public class EntityNotFoundException extends DaoOperationException {
    ...
    public <T> EntityNotFoundException(Class<T> entityClass, JSONObject condition) {
        super(DbOperation.SELECT, entityClass, message);
        setCondition(condition);
    }

    public <T> EntityNotFoundException(Class<T> entityClass, String columnName, Object columnValue) {
        super(DbOperation.SELECT, entityClass, message);
