...
public interface IRoleIssueService extends IService<RoleIssue> {
     ...
     * @throws NotFoundException 无该用户时且createCreateUserIfAbsent = false时
     * @throws NoneffectiveRoleException 角色当前不可用
     * @throws DaoOperationException 自动创建用户失败
     */
    void issueRole(String externalUserId, Long roleId, boolean createCreateUserIfAbsent) throws NotFoundException, NoneffectiveRoleException, DaoOperationException;
